...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference("Medico.count") do
      post medicos_url, params: { medico: { crm: @medico.crm, especialidade: @medico.especialidade, nome: @medico.nome } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { crm: @medico.crm, especialidade: @medico.especialidade, nome: @medico.nome } }
